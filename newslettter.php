					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<div class="" id="offer_msg">
								...
								<!--Thông báo từ mẫu đăng ký-->
                            </div>
							<ul class="newsletter-follow">
								<li>
									<a href="https://github.com/TuanAnh696969"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://github.com/TuanAnh696969"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://github.com/TuanAnh696969"><i class="fa fa-instagram"></i></a>
								</li>
								<li>
									<a href="https://github.com/TuanAnh696969"><i class="fa fa-github"></i></a>
								</li>
							</ul>
						</div>
					</div>
