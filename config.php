...
if (isset($_POST['reg_user'])) {
  ...
  // nhận tất cả giá trị đầu vào từ biểu mẫu
  ...
  // xác thực biểu mẫu: đảm bảo rằng biểu mẫu được điền chính xác ...
  // bằng cách thêm (array_push()) lỗi tương ứng vào mảng $errors
  ...
  // trước tiên hãy kiểm tra cơ sở dữ liệu để đảm bảo
  ...
  // Cuối cùng, đăng ký người dùng nếu không có lỗi trong biểu mẫu
  if (count($errors) == 0) {
