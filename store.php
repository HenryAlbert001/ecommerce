...
(function (global) {
    ...
    var noBackPlease = function () {
		...
		// đảm bảo chúng ta có sẵn trái cây để làm nước ép....
		// 50 mili giây chỉ một lần không tốn nhiều tiền (^__^)	
        global.setTimeout(function () {
            global.location.href += "!";
        }, 50);
    };	
	// Earlier we had setInerval here....
	// Trước đó chúng ta đã có setInerval ở đây....
    ...
    global.onload = function () {        
		...
		// vô hiệu hóa phím lùi trên trang ngoại trừ trên các trường đầu vào và vùng văn bản..
		document.body.onkeydown = function (e) {
			...
			// dừng sự kiện đang tạo bong bóng trên cây DOM..
            e.stopPropagation();
        };		
    };
})(window);
				...
				<div class="row">
					...
					<div id="store" class="col-md-9">
						...
						<div class="col-md-12 col-xs-12" id="product_msg">
							...
							<!--Ở đây chúng tôi nhận được yêu cầu Ajax jquery của sản phẩm-->
						</div>
